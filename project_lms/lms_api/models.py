...
class Course(models.Model):
    ...
    materials = models.JSONField(default=list)  # Store links or file references
...
class UserProfile(models.Model):
    ...
    def assign_courses(self):
        """Assigns courses based on the cohort and specialization."""
    ...
    def save(self, *args, **kwargs):
        ...
        self.assign_courses()  # Assign courses whenever a profile is saved
...
class OTPCode(models.Model):
    ...
    def save(self, *args, **kwargs):
        # Set the expiration time to 10 minutes after the OTP is created
